...
; 0000 0023 // Port A initialization, ¬се разр€ды порта A - на вывод с нулевыми нач. значени€ми
...
; 0000 0036 // Mode: Normal top=FFh
; 0000 0037 // OC0 output: Disconnected
; 0000 0038 TCCR0=0x00;         //в исходном состо€нии TC0 остановлен и обнулен
	OUT  0x33,R30
...
; 0000 003E // Clock value: 500,000 kHz
...
; 0000 0055 // INT0: On
; 0000 0056 // INT0 Mode: Rising Edge
; 0000 0057 // INT1: On
; 0000 0058 // INT1 Mode: Falling Edge
; 0000 0059 // INT2: Off
; 0000 005A GICR|=(1<<INT1) | (1<<INT0) | (0<<INT2);
	IN   R30,0x3B
	ORI  R30,LOW(0xC0)
	OUT  0x3B,R30
; 0000 005B MCUCR=(1<<ISC11) | (0<<ISC10) | (1<<ISC01) | (1<<ISC00);
	LDI  R30,LOW(11)
	OUT  0x35,R30
; 0000 005C MCUCSR=(0<<ISC2);
	LDI  R30,LOW(0)
	OUT  0x34,R30
; 0000 005D GIFR=(1<<INTF1) | (1<<INTF0) | (0<<INTF2);
	LDI  R30,LOW(192)
	OUT  0x3A,R30
; 0000 005E 
; 0000 005F // Timer(s)/Counter(s) Interrupt(s) initialization
; 0000 0060 TIMSK=1<<OCIE1A;			//–азрешение прерывани€ по совпадению A TC1
	LDI  R30,LOW(16)
	OUT  0x39,R30
; 0000 0061 
; 0000 0062 // Analog Comparator initialization
; 0000 0063 // Analog Comparator: Off
; 0000 0064 // Analog Comparator Input Capture by Timer/Counter 1: Off
; 0000 0065 ACSR=0x80;
	LDI  R30,LOW(128)
	OUT  0x8,R30
...
; 0000 0069 #asm("sei")         //–азрешение прерываний
	sei
; 0000 006A 
; 0000 006B while (1)           //Ѕесконечный цикл
_0x3:
; 0000 006C       {
; 0000 006D       };
	RJMP _0x3
