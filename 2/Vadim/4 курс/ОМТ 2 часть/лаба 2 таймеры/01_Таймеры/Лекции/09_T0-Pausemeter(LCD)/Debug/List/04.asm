...
_0x0:
	.DB  0x4D,0x65,0x61,0x73,0x75,0x72,0x69,0x6E
	.DB  0x67,0x20,0x50,0x61,0x75,0x73,0x65,0x20
	.DB  0x74,0x69,0x6D,0x65,0x0,0x54,0x70,0x61
	.DB  0x75,0x73,0x65,0x20,0x3E,0x20,0x32,0x35
	.DB  0x35,0x20,0x6D,0x6B,0x73,0x0,0x54,0x70
	.DB  0x61,0x75,0x73,0x65,0x3D,0x25,0x33,0x75
	.DB  0x20,0x6D,0x6B,0x73,0x20,0x20,0x0
_0x2020003:
	.DB  0x80,0xC0
...
; 0000 0061 sprintf (string_lcd1,"Measuring Pause time");   //Формирование текстового буфера для 1-ой строки LCD
	LDI  R30,LOW(_string_lcd1)
	LDI  R31,HIGH(_string_lcd1)
	ST   -Y,R31
	ST   -Y,R30
	__POINTW1FN _0x0,0
	CALL SUBOPT_0x0
; 0000 0062 lcd_puts(string_lcd1);                          //Выводим на LCD 1-ю строку текста
	LDI  R26,LOW(_string_lcd1)
	LDI  R27,HIGH(_string_lcd1)
	CALL _lcd_puts
...
; 0000 006A             sprintf (string_lcd2,"Tpause > 255 mks");       //вывод диагностического сообщения
	LDI  R30,LOW(_string_lcd2)
	LDI  R31,HIGH(_string_lcd2)
	ST   -Y,R31
	ST   -Y,R30
	__POINTW1FN _0x0,21
	CALL SUBOPT_0x0
...
; 0000 006E       lcd_puts(string_lcd2);                    //вывод измеренной паузы на LCD
	LDI  R26,LOW(_string_lcd2)
	LDI  R27,HIGH(_string_lcd2)
	CALL _lcd_puts
