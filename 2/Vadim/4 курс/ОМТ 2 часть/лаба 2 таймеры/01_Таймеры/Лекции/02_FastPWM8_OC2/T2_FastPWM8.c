...
// Инициализация 7-го разряда порта D (PD.7) на вывод с ннулевым начальным значением
...
TCNT2=0x00;
OCR2=51;                            //Коэффициент заполнения импульсов 0,2=51/256

// Запрет всех прерываний от таймера
