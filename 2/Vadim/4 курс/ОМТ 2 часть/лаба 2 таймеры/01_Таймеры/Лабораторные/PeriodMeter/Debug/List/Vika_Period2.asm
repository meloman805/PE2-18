...
; 0000 0021 TCNT1H=0x00;
	RCALL SUBOPT_0x0
; 0000 0022  TCNT1L=0x00;
; 0000 0023   TCCR1B=0x05;
; 0000 0024 }
	LD   R30,Y+
	RETI
; .FEND
...
; 0000 003D DDRA=(1<<DDA7) | (1<<DDA6) | (1<<DDA5) | (1<<DDA4) | (1<<DDA3) | (1<<DDA2) | (1<<DDA1) | (1<<DDA0);
	LDI  R30,LOW(255)
	OUT  0x1A,R30
...
; 0000 0081 // INT0: On
; 0000 0082 // INT0 Mode: Rising Edge
; 0000 0083 // INT1: On
; 0000 0084 // INT1 Mode: Falling Edge
; 0000 0085 // INT2: Off
; 0000 0086 GICR|=(1<<INT1) | (1<<INT0) | (0<<INT2);
	IN   R30,0x3B
	ORI  R30,LOW(0xC0)
	OUT  0x3B,R30
; 0000 0087 MCUCR=(1<<ISC11) | (0<<ISC10) | (1<<ISC01) | (1<<ISC00);
	LDI  R30,LOW(11)
	OUT  0x35,R30
; 0000 0088 MCUCSR=(0<<ISC2);
	LDI  R30,LOW(0)
	OUT  0x34,R30
; 0000 0089 GIFR=(1<<INTF1) | (1<<INTF0) | (0<<INTF2);
	LDI  R30,LOW(192)
	OUT  0x3A,R30
; 0000 008A 
