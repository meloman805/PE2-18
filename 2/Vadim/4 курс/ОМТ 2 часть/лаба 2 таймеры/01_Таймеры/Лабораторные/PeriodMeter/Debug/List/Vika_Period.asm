...
; 0000 0028     count=0;
	CLR  R4
	CLR  R5
; 0000 0029     PORTB=TCNT1H;
	IN   R30,0x2D
	OUT  0x18,R30
; 0000 002A     PORTA=TCNT1L;
	IN   R30,0x2C
	OUT  0x1B,R30
; 0000 002B     }
_0x4:
...
; 0000 0035 DDRA=(1<<DDA7) | (1<<DDA6) | (1<<DDA5) | (1<<DDA4) | (1<<DDA3) | (1<<DDA2) | (1<<DDA1) | (1<<DDA0);
	LDI  R30,LOW(255)
	OUT  0x1A,R30
...
; 0000 003B DDRB=(1<<DDB7) | (1<<DDB6) | (1<<DDB5) | (1<<DDB4) | (1<<DDB3) | (1<<DDB2) | (1<<DDB1) | (1<<DDB0);
	LDI  R30,LOW(255)
	OUT  0x17,R30
...
; 0000 0079 // INT0: On
; 0000 007A // INT0 Mode: Any change
; 0000 007B // INT1: Off
; 0000 007C // INT2: Off
; 0000 007D GICR|=(0<<INT1) | (1<<INT0) | (0<<INT2);
	...
	ORI  R30,0x40
	OUT  0x3B,R30
; 0000 007E MCUCR=(0<<ISC11) | (0<<ISC10) | (0<<ISC01) | (1<<ISC00);
	LDI  R30,LOW(1)
	OUT  0x35,R30
