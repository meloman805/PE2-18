...
switch (a)
    {
    case 1: OCR2=63; break;         //Если a=1, то OCR2=64
    case 2: OCR2=31; break;         //Если a=2, то OCR2=32
    case 3: OCR2=15; break;         //Если а=3, то OCR2=16
    case 4: OCR2=127; a=0; break;   //Если а=4, то OCR2=128; a=0;
...
TCNT2=0x00;
OCR2=127;               //Для скважности q=2 в 1-ом периоде ШИМ-сигнала
